					...
					<form action="do_approval_1.php">
								...
								else
								{
									...
									<div class="form-check">
										<label class="form-check-label">
											<input type="checkbox" class="form-check-input" name="rejected_<?php echo $no;?>" id="rejected_<?php echo $no;?>" value="rejected" <?php if($result['approval_1']=='2'){echo "disabled checked";}?>>Reject
						...
						<tr>
							<td colspan="7" class="text-right">
								...
								$ckpprvd = "SELECT sent, approval_1
								FROM tb_approval
