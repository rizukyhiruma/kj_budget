...
<div class="container">
	...
	{	
		...
		$appstt = "SELECT * FROM tb_approval 
		WHERE approval_1 = '1' 
					...
					<form action="do_approval_2.php">
								...
								else
								{
									...
									<div class="form-check">
										<label class="form-check-label">
											<input type="checkbox" class="form-check-input" name="rejected_<?php echo $no;?>" id="rejected_<?php echo $no;?>" value="rejected" <?php if($result['approval_2']=='2'){echo "disabled checked";}?>>Reject
						...
						<tr>
							<td colspan="7" class="text-right">
								...
								$ckpprvd = "SELECT sent, approval_2
								FROM tb_approval
