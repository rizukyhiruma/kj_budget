	...
	if($_SESSION['type'] == "Finance" || $_SESSION['type'] == "Super Admin")
	{
		...
		<table class="table table-hover">
			...
			<tbody>
				...
				WHERE periode='$periode' and sent = '1'";
				...
				while($periode2b = $periode2a->fetch_array())
				{
					...
					<tr>
						...
						<td><a href="approval_1b.php?id_periode=<?php echo $periode2b['id_periode'];?>&id_user=<?php echo $periode2b['id_user'];?>" type="button" class="btn btn-primary">Open</a></td>
					</tr>
					<?php
				}
				?>
